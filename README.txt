...
"Julila" floor loom with stepper motors that independently operate up to 
8 shafts. That not only makes setup and weaving easier, but it also 
allows patterns that would otherwise not be possible. 
